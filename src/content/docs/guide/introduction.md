...
For a complete breakdown of the packages, services, and optional tools required by NAnDoroid-shell, please refer to the dedicated [Dependencies](/guide/dependencies/) page.
