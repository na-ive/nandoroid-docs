---
title: Perintah IPC & Keybinds
description: Referensi untuk perintah IPC dan shortcut global Nandoroid Shell.
---

Sintaks dasar untuk memanggil perintah melalui terminal adalah:

```bash
qs -c nandoroid ipc call <target> <method>
```

*(Catatan: `qs` adalah alias untuk `quickshell`. Ganti dengan perintah lengkap jika kamu tidak menggunakan alias.)*

### Sidebar & Panels

Mengelola visibilitas semua panel UI.

| Fitur | Target | Metode | Perintah Terminal |
| :---------------------- | :-------------- | :------- | :---------------------------------------------- |
...
Memicu aksi berdasarkan seleksi area layar.

| Aksi | Target | Metode | Perintah Terminal |
| :-------------------- | :------- | :---------------- | :------------------------------------------------ |
...
Mengontrol layanan sistem spesifik.
...
Nandoroid menggunakan Shortcut Global bawaan (native) Quickshell untuk operasi tool khusus. Shortcut ini dipicu menggunakan dispatcher `global` di Hyprland dengan format `quickshell:<nama>`.

| Nama Shortcut | Deskripsi | Contoh Bind Lua di Hyprland |
| :---------------------- | :------------------------------- | :----------------------------------------------------------------------------------------- |
